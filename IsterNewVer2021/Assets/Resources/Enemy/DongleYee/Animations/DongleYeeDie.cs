...
public class DongleYeeDie : StateMachineBehaviour
{
    Shadow _shadow;
    DongleYeeMovable _movable;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        _movable = animator.GetComponentInParent<DongleYeeMovable>();
        _nevi = animator.GetComponentInParent<NavMeshAgent>();
        //_shadow = _movable.gameObject.GetComponentInChildren<Shadow>();
