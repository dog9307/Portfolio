...
public class ActiveMarkerUser : FloorSkillUser
{
    public bool isStack { get; set; }
    public bool isRandomDebuff { get; set; }

    public float tickMultiplier { get; set; }
    ...
    protected override void Start()
    {
        ...
        skill = info.FindSkill<ActiveMarker>();
    ...
    public override void CreateObject()
    {
        ...
        GameObject markerFloor = _creator.CreateObject();

        if (_frameCount < FRAME_LIMIT)
            markerFloor.transform.position = PlayerSkillUsage.useMousePointToWorld;

        ActiveMarkerController controller = markerFloor.GetComponent<ActiveMarkerController>();
