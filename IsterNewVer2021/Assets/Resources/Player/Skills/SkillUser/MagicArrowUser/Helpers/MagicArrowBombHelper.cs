...
public class MagicArrowBombHelper : MagicArrowUserHelperBase
{
    ...
    public override GameObject CreateObject()
    {
        ...
        MagicArrowBombCreator creator = newBullet.GetComponent<MagicArrowBombCreator>();
        creator.isLavaCreate = isLavaCreate;
    ...
    public override void Init()
    {
        ...
        if (!effectPrefab)
            effectPrefab = Resources.Load<GameObject>("Player/Bullets/MagicArrow/MagicArrowBomb/Prefab/MagicArrow_BombCreate");
    }
