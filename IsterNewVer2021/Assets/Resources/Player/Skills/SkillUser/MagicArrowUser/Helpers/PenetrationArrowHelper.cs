...
public class PenetrationArrowHelper : MagicArrowUserHelperBase
{
    public bool isAddDotted { get; set; }
    private GameObject _dottedPrefab;
    ...
    public override GameObject CreateObject()
    {
        ...
        {
            if (!_dottedPrefab)
                _dottedPrefab = Resources.Load<GameObject>("Player/Bullets/MagicArrow/PenetrationArrow/Prefab/MagicArrowDotted");

            GameObject dotted = GameObject.Instantiate(_dottedPrefab);
            dotted.transform.parent = newBullet.transform;
            dotted.transform.localPosition = Vector3.zero;
        }
    ...
    public override void Init()
    {
        ...
        if (!effectPrefab)
            effectPrefab = Resources.Load<GameObject>("Player/Bullets/MagicArrow/PenetrationArrow/Prefab/PenetrationArrow");
    }
