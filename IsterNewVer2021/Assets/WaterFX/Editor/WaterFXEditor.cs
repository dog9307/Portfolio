...
public class WaterFXEditor : Editor {
	...
	SerializedProperty	m_borderIncreaseCoef;
	...
	void OnEnable()
	{
		...
		m_borderIncreaseCoef	= serializedObject.FindProperty("m_borderIncreaseCoef");
	}
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.PropertyField(m_borderIncreaseCoef);
