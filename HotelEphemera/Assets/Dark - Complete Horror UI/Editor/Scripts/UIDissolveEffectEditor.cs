...
namespace Michsky.UI.Dark
{
    ...
    public class UIDissolveEffectEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var afterDissolveOut = serializedObject.FindProperty("afterDissolveOut");
            var isDissolveOut = serializedObject.FindProperty("_isDissolveOut");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    GUILayout.Space(2);
                    EditorGUILayout.PropertyField(afterDissolveOut, new GUIContent("On After DissolveOut"), true);
                    GUILayout.Space(2);
                    isDissolveOut.boolValue = EditorGUILayout.Toggle("isDissolveOut", isDissolveOut.boolValue);
